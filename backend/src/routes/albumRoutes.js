...
const { createAlbum, updateAlbum, deleteAlbum, getAlbums, getAlbum } = require('../controllers/albumController')
...
routes.post('/',auth,albumValidation(),handleValidation,createAlbum)
